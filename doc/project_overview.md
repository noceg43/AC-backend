# AlphaConnect API Documentation

Welcome to the documentation for the AlphaConnect API. This project provides a backend service for a matching application, allowing users to be matched based on their answers to a set of questions.
...
*   **[Matching Algorithm](/doc/matching_algorithm.md):** An explanation of the matching algorithm used to pair users.
*   **[Questions and Answers](/doc/questions_and_answers.md):** Information about the `questions` and `answers` blueprints and their role in the matching process.
